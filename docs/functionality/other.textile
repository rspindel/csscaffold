Scaffold also provides some other functionality which doesn't fall under the other categories.

h2. Chained Properties
...
|_.Dependencies|_.Added|_.Updated|
|Scaffold, .htaccess, Apache Gzip|1.0|-|
