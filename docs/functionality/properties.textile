Scaffold can add some new properties for you to use within your CSS. They perform special tasks, as they have access to the properties of the element.

h2. image-replace:url();
