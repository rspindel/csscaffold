...
require '../scaffold/system/libraries/Bootstrap.php';

$config['system'] = '../scaffold/system/';
$config['cache'] = $config['system'] . 'cache/';

$flags = (isset($_GET['flags'])) ? $_GET['flags'] : null;
...
/**
 * Prints out the value and exits. Used for internal debugging.
 *
